...
public class UIPracticasInternacion extends JFrame {
	...
	private String[] columnasPractica = { "Código", "Descripción de la Práctica", "Arancel", "Costo Final", "Estado",
			"Código Aut.", "Fecha Aut.", "Sesiones", "Médico" };
	...
	public UIPracticasInternacion() {
		...
		comboBox = new JComboBox<MedicoDTO>();
		comboBox.setBounds(928, 375, 144, 20);
		...
		lblMdico.setBounds(928, 355, 144, 16);
